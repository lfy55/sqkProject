...
(function () {
  ...
  var _ = function (obj) {
    ...
    /**
     * 如果是通过 new 运算符调用的 `_` 函数，且 obj 不是 `_` 函数的实例则：
     */
  ...
  // 闭包
  /**
   * 根据一个 `key` 返回一个接受对象的函数
   * 该函数接收一个对象参数并返回该对象的 `key` 对应的值
   */
