Vue.component('nianluntu-junfen',{
		...
		function upDate() {
			...
			for(let x = 0;x<_this.dataConfig.length;x++) {
				...
				arcs.on("mouseover", function (d) {
	                	d3.select(this).select(".svg-border").attr("stroke","#00ff00").attr("stroke-width","3px");
	                ...
	                .on("mouseout", function () {
	                	d3.select(this).select(".svg-border").attr("stroke","#ff0000").attr("stroke-width","1px");
